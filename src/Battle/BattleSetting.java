...
public class BattleSetting {
    public static int itemR = 240;
    public static int itemG = 255;
    public static int itemB = 240;
    public static int wordR = 0;
    public static int wordG = 0;
    public static int wordB = 0;
    ...
    public static int shopTestTime = 40;
    public static int shopTime = shopTestTime;
    public static int fightTime = 5;

    public static String [] itemName = {"ITEM0", "ITEM1", "ITEM2", "ITEM3", "IMTE4", "ITEM5", "ITEM6", "ITEM7", "ITEM8"};
}
